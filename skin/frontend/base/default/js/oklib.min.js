var oklibpresenter=function(){var a,b;return{instantiate:function(){"undefined"===typeof a&&(a=new window.oklib.OKLIBLite);"undefined"===typeof b&&(b=new window.oklib.OKLIBLite)},showExisting:function(c){"cash"===c?a.show():"open"===c&&b.show()},showNew:function(c,d){var e={color:"dark",culture:d.culture,initiation:d.initiation};"cash"===c?(e.loaded=a.start,a.init("t",d.guid,e,d.environment)):"open"===c&&(e.loaded=b.start,b.init("a",d.guid,e,d.environment))},isInitialized:function(c){if("cash"===
c)return a.isInitialized();if("open"===c)return b.isInitialized()},reset:function(c){"cash"===c?(a.isInitialized()&&a.hide(),a=new window.oklib.OKLIBLite):"open"===c&&(b.isInitialized()&&b.hide(),b=new window.oklib.OKLIBLite)}}}();function showMessage(a,b){var c=window.jQuery(".col-main"),d='<li class="'+b+'-msg"><ul><li>'+a+"</li></ul></li>",e=window.jQuery("ul.messages");null!=e&&e.length||(e=window.jQuery('<ul class="messages"></ul>').prependTo(c));e.append(window.jQuery(d))}
